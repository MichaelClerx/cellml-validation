...
`3.4.3.6.variable_interfaces_both_in`: Error in invalid file detected
...
`3.4.3.8.variable_interfaces_private_in_and_initial`: Error in invalid file detected

`3.4.3.8.variable_interfaces_public_in_and_initial`: Error in invalid file detected
...
`5.4.1.1.units_base_units_with_children`: Error in invalid file detected

❌ `5.4.1.1.units_empty_1`: Valid file failed validation
* Returned: 
...
❌ `5.4.1.1.units_empty_2`: Valid file failed validation
* Returned: 
...
`5.4.2.7.unit_offset_and_exponent`: Error in invalid file detected

`5.4.2.7.unit_offset_and_siblings_1`: Error in invalid file detected

`5.4.2.7.unit_offset_and_siblings_2`: Error in invalid file detected
...
`6.4.1.1.group_component_ref_missing_1`: Error in invalid file detected
...
`6.4.1.1.group_relationship_ref_missing_1`: Error in invalid file detected
...
`6.4.2.4.relationship_ref_encapsulation_duplicate`: Error in invalid file detected

`6.4.2.4.relationship_ref_encapsulation_named`: Error in invalid file detected
...
`7.4.1.3.reaction_encapsulating_delta_variable`: Error in invalid file detected
...
`7.4.3.3.role_rate_with_delta_variable`: Error in invalid file detected

`7.4.3.3.role_rate_with_multiple_roles`: Error in invalid file detected

`7.4.3.3.role_rate_with_stoichiometry`: Error in invalid file detected
...
`7.4.3.5.role_direction_both_product`: Error in invalid file detected

`7.4.3.5.role_direction_both_rate`: Error in invalid file detected

`7.4.3.5.role_direction_both_reactant`: Error in invalid file detected

❌ `7.4.3.5.role_direction_reverse_irreversible`: Invalid file passed validation

`7.4.3.5.role_direction_reverse_product`: Error in invalid file detected

`7.4.3.5.role_direction_reverse_rate`: Error in invalid file detected

`7.4.3.5.role_direction_reverse_reactant`: Error in invalid file detected
...
`7.4.3.8.role_delta_variable_activator`: Error in invalid file detected

`7.4.3.8.role_delta_variable_catalyst`: Error in invalid file detected

`7.4.3.8.role_delta_variable_inhibitor`: Error in invalid file detected

`7.4.3.8.role_delta_variable_modifier`: Error in invalid file detected
...
`7.4.3.8.role_delta_variable_without_rate_or_math`: Error in invalid file detected
