...
Performance:
* 96% according to spec (129 out of 134)
* 0 out of 0 valid files passed
* 129 out of 134 invalid files detected

Issues:
* 0 valid files failed validation
* 3 invalid files passed validation
...
|-|-|-|-|-|-|-|
|[0. Not mentioned in spec](#0-not-mentioned-in-spec)|0|10|0|0|0|100%|
|[2. Fundamentals](#2-fundamentals)|0|26|0|0|1|96%|
|[3. Model structure](#3-model-structure)|0|93|0|3|1|95%|
...
❗`0.0.root_namespace_1`: **Test not run**
...
❗`5.2.1.units_ampere`: **Test not run**

❗`5.2.1.units_becquerel`: **Test not run**

❗`5.2.1.units_candela`: **Test not run**

❗`5.2.1.units_celsius`: **Test not run**

❗`5.2.1.units_coulomb`: **Test not run**

❗`5.2.1.units_dimensionless`: **Test not run**

❗`5.2.1.units_farad`: **Test not run**

❗`5.2.1.units_gram`: **Test not run**

❗`5.2.1.units_gray`: **Test not run**

❗`5.2.1.units_henry`: **Test not run**

❗`5.2.1.units_hertz`: **Test not run**

❗`5.2.1.units_joule`: **Test not run**

❗`5.2.1.units_katal`: **Test not run**

❗`5.2.1.units_kelvin`: **Test not run**

❗`5.2.1.units_kilogram`: **Test not run**

❗`5.2.1.units_liter`: **Test not run**

❗`5.2.1.units_litre`: **Test not run**

❗`5.2.1.units_lumen`: **Test not run**

❗`5.2.1.units_lux`: **Test not run**

❗`5.2.1.units_meter`: **Test not run**

❗`5.2.1.units_metre`: **Test not run**

❗`5.2.1.units_mole`: **Test not run**

❗`5.2.1.units_newton`: **Test not run**

❗`5.2.1.units_ohm`: **Test not run**

❗`5.2.1.units_pascal`: **Test not run**

❗`5.2.1.units_radian`: **Test not run**

❗`5.2.1.units_second`: **Test not run**

❗`5.2.1.units_siemens`: **Test not run**

❗`5.2.1.units_sievert`: **Test not run**

❗`5.2.1.units_steradian`: **Test not run**

❗`5.2.1.units_tesla`: **Test not run**

❗`5.2.1.units_volt`: **Test not run**

❗`5.2.1.units_watt`: **Test not run**

❗`5.2.1.units_weber`: **Test not run**
