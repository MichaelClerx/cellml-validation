...
* Expected: ```Multiple definitions```
* Output: ```Multiple definitions for A$x (AA$x and Eq(_A$x, _1.0))```
...
* Expected: ```Multiple definitions```
* Output: ```Multiple definitions for AA$x (A$x and Eq(_AA$x, _1.0))```
...
* Output: ```Parent of component C already B. Cannot set A!```
