...
Performance:
* 80% according to spec (8 out of 10)
* 8 out of 10 valid files passed
...
|-|-|-|-|-|-|-|
|[0. Not mentioned in spec](#0-not-mentioned-in-spec)|5|0|1|0|0|83%|
|[2. Fundamentals](#2-fundamentals)|3|0|1|0|0|75%|
...
🔴 [0.1.real_numbers_extreme](../models_1_0/valid/0.1.real_numbers_extreme.cellml): **Valid file failed validation.**
