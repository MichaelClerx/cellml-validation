...
|2. Fundamentals|18|22|1|5|0|86%|
|3. Model structure|50|153|0|0|0|100%|
|4. Mathematics|40|14|5|5|0|84%|
|5. Units|89|74|10|4|8|88%|
|6. Grouping|16|65|1|7|0|91%|
|7. Reactions|5|50|0|29|0|65%|
|8. Metadata framework|30|0|0|1|0|96%|
|C. Advanced units functionality|42|0|3|0|0|93%|
...
* Output: ```[Error] [2:181] Unexpected attribute fruit found - not valid here.```

[2.4.2.imaginary_attributes_2](../models_1_0/invalid/2.4.2.imaginary_attributes_2.cellml): Error detected correctly.
* Expected: ```Unexpected attribute fruit found```
* Output: ```[Error] [2:244] Unexpected attribute fruit found - not valid here.```
...
* Expected: ```any characters that occur immediately within elements in the CellML```
* Output: ```[Error] [2:54] Per section 2.4.4 of the CellML specification, any characters that occur immediately within elements in the CellML namespace must be either space (#x20) characters, carriage returns (#xA), line feeds (#xD), or tabs (#x9).```
...
* Output: ```[Error] [2:54] The CellML specification says the name attribute is required here.```
...
* Expected: ```MUST define a units attribute```
* Output:
  * ```[Error] [2:66] Found a unit with no units attribute in units wooster; .```
  * ```[Warning] [2:66] Cannot perform any further checking of unit names due to problems processing the model units.```
  * ```[Error] [4:6] Each  /  element MUST define a units attribute (section 3.4.3.1 / 5.4.3.1).```
...
* Output:
  * ```[Error] [2:62] Units are defined circularly. One unit in the cycle is wooster; .```
  * ```[Warning] [2:62] Cannot perform any further checking of unit names due to problems processing the model units.```

[5.4.2.2.unit_cycle_2](../models_1_0/invalid/5.4.2.2.unit_cycle_2.cellml): Error detected correctly.
* Expected: ```Units are defined circularly```
* Output:
  * ```[Error] [2:73] Units are defined circularly. One unit in the cycle is fluther; .```
  * ```[Warning] [2:73] Cannot perform any further checking of unit names due to problems processing the model units.```
...
* Output:
  * ```[Error] [2:67] Units wooster references units ribbles but the latter units could not be found; .```
  * ```[Warning] [2:67] Cannot perform any further checking of unit names due to problems processing the model units.```
