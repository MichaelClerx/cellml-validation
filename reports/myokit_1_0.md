...
Performance:
* 91% according to spec (311 out of 340)
* 291 out of 317 valid files passed
* 20 out of 23 invalid files detected

Issues:
* 26 valid files failed validation
...
|[2. Fundamentals](#2-fundamentals)|15|10|4|3|0|78%|
|[3. Model structure](#3-model-structure)|46|0|4|0|0|92%|
|[4. Mathematics](#4-mathematics)|45|0|0|0|0|100%|
|[5. Units](#5-units)|93|0|7|0|0|93%|
|[6. Grouping](#6-grouping)|17|0|0|0|0|100%|
|[7. Reactions](#7-reactions)|0|0|5|0|0|0%|
|[8. Metadata framework](#8-metadata-framework)|24|0|6|0|0|80%|
...
* Output: ```Root node must be in CellML 1.0 or 1.1 namespace.```
...
* Output: ```Root node must be a CellML model element.```

[0.0.root_node_two_elements](../models_1_0/invalid/0.0.root_node_two_elements.cellml): Error detected correctly.
* Expected: ```junk after document element```
* Output: ```Unable to parse document: junk after document element: line 5, column 0```
...
* Output: ```If given, a variable initial_value must be a real number (3.4.3.7).```
...
* Output: ```Component name must be a valid CellML identifier (3.4.2.2).```
...
* Output: ```Unexpected attribute "fruit" found in cellml:model[@name="imaginary_attributes_1"].```
...
* Output: ```Unexpected content type in cellml:model[@name="imaginary_elements"], found element of type cellml:fruit.```
...
* Output: ```CellML element cellml:component found inside extension element {http://fruit.org}banana (2.4.3).```
...
* Output: ```Reaction elements are not supported.```
...
* Output: ```Text found in cellml:component[@name="c1"].```
...
* Output: ```Text found in cellml:component_ref.```
...
* Output: ```Units with non-zero offsets are not supported.```
...
* Output: ```Defining new base units is not supported.```
