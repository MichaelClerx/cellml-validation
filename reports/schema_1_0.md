...
`0.0.root_node_namespace_wrong`: Error in invalid file detected

`0.0.root_node_not_model`: Error in invalid file detected
...
`0.1.real_number_invalid_1`: Error in invalid file detected

`0.1.real_number_invalid_2`: Error in invalid file detected

`0.1.real_number_invalid_3`: Error in invalid file detected

`0.1.real_number_invalid_4`: Error in invalid file detected

`0.1.real_number_invalid_5`: Error in invalid file detected

`0.1.real_number_invalid_6`: Error in invalid file detected
...
`2.4.1.identifier_empty`: Error in invalid file detected

`2.4.1.identifier_only_underscore`: Error in invalid file detected

`2.4.1.identifier_unexpected_character_1`: Error in invalid file detected

`2.4.1.identifier_unexpected_character_2`: Error in invalid file detected

`2.4.1.identifier_unexpected_character_unicode`: Error in invalid file detected
...
❌ `2.4.3.cellml_attributes_inside_extensions`: Invalid file passed validation

❌ `2.4.3.cellml_elements_inside_extensions`: Invalid file passed validation

`2.4.3.component_ref_with_extensions`: Valid file passed OK

`2.4.3.component_with_extensions`: Valid file passed OK

`2.4.3.connection_with_extensions`: Valid file passed OK

`2.4.3.group_with_extensions`: Valid file passed OK

`2.4.3.map_components_with_extensions`: Valid file passed OK

`2.4.3.map_variables_with_extensions`: Valid file passed OK

`2.4.3.model_with_extensions`: Valid file passed OK

`2.4.3.reaction_with_extensions`: Valid file passed OK

`2.4.3.relationship_ref_with_extensions`: Valid file passed OK

`2.4.3.role_with_extensions`: Valid file passed OK

`2.4.3.unit_with_extensions`: Valid file passed OK

`2.4.3.units_with_extensions`: Valid file passed OK

`2.4.3.variable_ref_with_extensions`: Valid file passed OK

`2.4.3.variable_with_extensions`: Valid file passed OK
...
`2.5.1.identifiers_are_case_sensitive`: Error in invalid file detected
...
❌ `3.4.1.1.model_with_math`: Invalid file passed validation
...
`3.4.1.2.model_name_invalid`: Error in invalid file detected
...
`3.4.2.2.component_name_duplicate`: Error in invalid file detected

`3.4.2.2.component_name_invalid`: Error in invalid file detected
...
❌ `3.4.3.1.variable_with_math`: Invalid file passed validation
...
`3.4.3.2.variable_name_duplicate`: Error in invalid file detected

`3.4.3.2.variable_name_invalid`: Error in invalid file detected
...
`3.4.3.7.variable_initial_value_empty`: Error in invalid file detected

`3.4.3.7.variable_initial_value_invalid`: Error in invalid file detected
...
❌ `3.4.4.1.connection_map_components_missing`: Invalid file passed validation

❌ `3.4.4.1.connection_map_components_multiple`: Invalid file passed validation

❌ `3.4.4.1.connection_map_variables_missing_1`: Invalid file passed validation

❌ `3.4.4.1.connection_map_variables_missing_2`: Invalid file passed validation

❌ `3.4.4.1.connection_only_extensions`: Invalid file passed validation
...
❌ `3.4.4.1.connection_with_math`: Invalid file passed validation
...
❌ `3.4.5.1.map_components_with_math`: Invalid file passed validation
...
`3.4.5.2.map_components_component_1_nonexistent`: Error in invalid file detected


##### 3.4.5.3

`3.4.5.3.map_components_component_2_nonexistent`: Error in invalid file detected
...
`3.4.5.4.map_components_duplicate`: Error in invalid file detected
...
❌ `3.4.6.1.map_variables_with_math`: Invalid file passed validation
...
❌ `4.4.3.1.cn_units_missing`: Invalid file passed validation
...
`5.2.2.unit_deca`: Error in invalid file detected
...
❌ `5.4.1.1.units_with_math`: Invalid file passed validation
...
`5.4.1.2.units_name_duplicate_1`: Error in invalid file detected

`5.4.1.2.units_name_duplicate_2`: Error in invalid file detected

`5.4.1.2.units_name_invalid`: Error in invalid file detected
...
❌ `5.4.2.1.unit_with_math`: Invalid file passed validation
...
`5.4.2.3.unit_prefix_real`: Error in invalid file detected

`5.4.2.3.unit_prefix_real_int`: Error in invalid file detected

`5.4.2.3.unit_prefix_spaces`: Error in invalid file detected

`5.4.2.3.unit_prefix_unknown`: Error in invalid file detected


##### 5.4.2.4

`5.4.2.4.unit_exponent_invalid`: Error in invalid file detected


##### 5.4.2.5

`5.4.2.5.unit_multiplier_invalid`: Error in invalid file detected


##### 5.4.2.6

`5.4.2.6.unit_offset_invalid`: Error in invalid file detected
...
❌ `6.4.1.1.group_component_ref_missing_2`: Invalid file passed validation
...
❌ `6.4.1.1.group_only_extensions`: Invalid file passed validation

❌ `6.4.1.1.group_relationship_ref_missing_1`: Invalid file passed validation

❌ `6.4.1.1.group_relationship_ref_missing_2`: Invalid file passed validation
...
❌ `6.4.1.1.group_with_math`: Invalid file passed validation
...
`6.4.2.1.relationship_ref_name`: Valid file passed OK

`6.4.2.1.relationship_ref_relationship_1`: Valid file passed OK

`6.4.2.1.relationship_ref_relationship_2`: Valid file passed OK

❌ `6.4.2.1.relationship_ref_relationship_missing`: Invalid file passed validation
...
❌ `6.4.2.1.relationship_ref_with_math`: Invalid file passed validation
...
`6.4.2.2.relationship_ref_relationship_invalid`: Error in invalid file detected


##### 6.4.2.3

`6.4.2.3.relationship_ref_name_invalid`: Error in invalid file detected

`6.4.2.3.relationship_ref_name_not_unique_model_wide`: Valid file passed OK
...
`6.4.2.5.relationship_ref_duplicate_named`: Error in invalid file detected
...
`6.4.2.5.relationship_ref_multiple_1`: Valid file passed OK

`6.4.2.5.relationship_ref_multiple_2`: Valid file passed OK

`6.4.2.5.relationship_ref_multiple_3`: Valid file passed OK
...
❌ `6.4.3.1.component_ref_with_math`: Invalid file passed validation
...
`6.4.3.2.component_ref_no_children_extension`: Valid file passed OK
...
`6.4.3.3.component_ref_component_invalid`: Error in invalid file detected

`6.4.3.3.component_ref_component_nonexistent_1`: Error in invalid file detected
...
❌ `7.4.1.1.reaction_with_math`: Invalid file passed validation
...
❌ `7.4.2.1.variable_ref_with_math`: Invalid file passed validation
...
`7.4.2.2.variable_ref_variable_duplicate`: Error in invalid file detected

`7.4.2.2.variable_ref_variable_hidden`: Error in invalid file detected

`7.4.2.2.variable_ref_variable_nonexistent`: Error in invalid file detected
...
`7.4.3.5.role_direction_role_duplicate`: Error in invalid file detected


##### 7.4.3.6

`7.4.3.6.role_stoichiometry_invalid`: Error in invalid file detected


##### 7.4.3.7

`7.4.3.7.role_delta_variable_duplicate_1`: Error in invalid file detected

`7.4.3.7.role_delta_variable_duplicate_2`: Error in invalid file detected

`7.4.3.7.role_delta_variable_nonexistent_1`: Error in invalid file detected

`7.4.3.7.role_delta_variable_nonexistent_2`: Error in invalid file detected
...
`8.4.2.rdf_in_component`: Valid file passed OK

`8.4.2.rdf_in_component_ref`: Valid file passed OK

`8.4.2.rdf_in_connection`: Valid file passed OK

`8.4.2.rdf_in_group`: Valid file passed OK

`8.4.2.rdf_in_map_components`: Valid file passed OK

`8.4.2.rdf_in_map_variables`: Valid file passed OK

`8.4.2.rdf_in_model`: Valid file passed OK

`8.4.2.rdf_in_reaction`: Valid file passed OK

`8.4.2.rdf_in_relationship_ref`: Valid file passed OK

`8.4.2.rdf_in_role`: Valid file passed OK

`8.4.2.rdf_in_unit`: Valid file passed OK

`8.4.2.rdf_in_units_1`: Valid file passed OK

`8.4.2.rdf_in_units_2`: Valid file passed OK

`8.4.2.rdf_in_variable`: Valid file passed OK

`8.4.2.rdf_in_variable_ref`: Valid file passed OK
