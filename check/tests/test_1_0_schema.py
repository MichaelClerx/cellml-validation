...
expected_errors = {
    ...
    '3.4.4.1.connection_map_variables_missing_1': None,
    '3.4.4.1.connection_map_variables_missing_2': None,
...
def test_invalid_model(name, path, schema, schema_parser, log):
    """
