...
expected_errors = {
    ...
    '0.0.root_node_not_model': None,
    '0.0.root_node_two_elements':
        'Extra content at the end of the document',
    '0.0.root_node_two_models':
        'Extra content at the end of the document',
    '0.0.root_node_namespace_wrong': None,
    # Not in spec: Real number format
    '0.1.real_number_invalid_1': None,
    '0.1.real_number_invalid_2': None,
    '0.1.real_number_invalid_3': None,
    '0.1.real_number_invalid_4': None,
    '0.1.real_number_invalid_5': None,
    '0.1.real_number_invalid_6': None,
    # 2.4.1 CellML Identifiers
    '2.4.1.identifier_empty': None,
    '2.4.1.identifier_only_underscore': None,
    '2.4.1.identifier_unexpected_character': None,
    '2.4.1.identifier_unexpected_character_2': None,
    '2.4.1.identifier_unexpected_character_unicode': None,
    ...
    '3.4.1.2.model_name_invalid': None,
    ...
    '3.4.2.2.component_name_invalid': None,
    ...
    '3.4.3.2.variable_name_invalid': None,
    ...
    '3.4.3.7.variable_initial_value_empty': None,
    '3.4.3.7.variable_initial_value_invalid': None,
    ...
    '5.4.1.2.units_name_invalid': None,
    ...
    '5.4.2.3.unit_prefix_real': None,
    '5.4.2.3.unit_prefix_real_int': None,
    '5.4.2.3.unit_prefix_spaces': None,
    '5.4.2.3.unit_prefix_unknown': None,
    # 5.4.2.4 A unit exponent must be a real number
    '5.4.2.4.unit_exponent_invalid': None,
    # 5.4.2.5 A unit multiplier must be a real number
    '5.4.2.5.unit_multiplier_invalid': None,
    # 5.4.2.6 A unit offset must be a real number
    '5.4.2.6.unit_offset_invalid': None,
    ...
    '6.4.2.2.relationship_ref_relationship_invalid': None,
    # 6.4.2.3 A relationship_ref name must be a cellml identifier
    '6.4.2.3.relationship_ref_name_invalid': None,
    ...
    '6.4.3.3.component_ref_component_invalid': None,
    ...
    '7.4.3.6.role_stoichiometry_invalid': None,
    # 7.4.3.7 The delta_variable must refer to a local variable
    '7.4.3.7.role_delta_variable_nonexistent_1': None,
    '7.4.3.7.role_delta_variable_nonexistent_2': None,
    # 7.4.3.7 The delta_variable must be unique component-wide
    '7.4.3.7.role_delta_variable_duplicate_1': None,
    '7.4.3.7.role_delta_variable_duplicate_2': None,
...
def test_valid_model(name, path, parser, dtd, log):
    """
...
def test_invalid_model(name, path, parser, dtd, log):
    """
